...
| AUD-011 | P2 — owner input required at UAT | The technical parity set is complete, but automated evidence cannot approve visual taste. The remote legacy runtime also did not serve product media during capture. | Obtain product-owner visual sign-off during RB-009/RB-010; refresh legacy product media only if that runtime becomes available. This does not block technical RB-008 completion. | 5/6 |
