    ...
    <Wrapper>
      ...
      <section id="SECTION_1">
        <div id="DIV_2">
          <ul id="UL_3">
            <li id="LI_4">
              <Link id="A_5" to="/spicer-products?category=dzhyn" />
              <div id="DIV_6" />
              <h3 id="H3_7">ДЖИН</h3>
            </li>
            <li id="LI_8">
              <Link id="A_9" to="/spicer-products?category=nastoyanky" />
              <div id="DIV_10" />
            ...
            <li id="LI_16">
              <Link id="A_17" to="/spicer-products?category=likery" />
              <div id="DIV_18" />
              <h3 id="H3_19">ЛІКЕРИ</h3>
            </li>
            <li className="stripes-card">
              <Link to="/spicer-products?category=spajsery">
